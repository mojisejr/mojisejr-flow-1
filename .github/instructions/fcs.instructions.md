...
- `/init` - Project initialization should be completed before creating context
- `/plan` OR `/plan2` - Context should reach `[Ready for Planning]` status before planning
- `/mode` - Current mode included in context creation
- Workflow system - Context is Phase 1 of development workflow (after initialization)
